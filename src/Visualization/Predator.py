...
class Predator(Agent):
    ...
    # Function that activates the predator sensor
    def prey_sensor(self, grid_maze, grid_agents, x, y):  # Parameters are x and y coordinates of the predator
        # This sensor checks the surroundings of the predator
            ...
            for paso in range(1, 6):
                ...
                if 0 <= ny < len(grid_maze) and 0 <= nx < len(grid_maze[0]):
                    ...
                    if valor == 3:  # Wall
                        ...
                        if grid_agents[ny][nx] == 1:  # There is a prey
